...
def build_default_dataloader(data_list:list) -> DataLoader:
    ...
    dataset = AudioEmotionDataset(data_list, '/home/nithish/Desktop/Tonal_Based_Emotion_Synthesis/data/spectrograms', '/home/nithish/Desktop/Tonal_Based_Emotion_Synthesis/data/mean_ratings_set1.csv')
